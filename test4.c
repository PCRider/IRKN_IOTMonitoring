...
int main(void){
        ...
        uint16_t dat_p;
        uint8_t i=0;
        uint8_t payloadlen=0; //warning: variable ‘payloadlen’ set but not used [-Wunused-but-set-variable] test_readSiliconRev.c:168:25: error: ‘payloadlen’ undeclared (first use in this function)
        char str[20];
